...
class FirstLoginFragmentWithGroupcode1 : Fragment() {
    ...
    override fun onStart() {
        ...
        cstlay_first_login_withgroupcode_3.setOnClickListener {
            var intent1 = Intent(context, GroupCreationActivity::class.java)
    ...
    fun sendText(){
        (activity as FirstLoginActivity).getValueFromFrag1(edtxt_first_login_withgroupcode.text.toString())
    }
